            ...
            <tr>
                ...
                <td class="px-6 py-4">
                    <div class="flex gap-3">
                        <a href="editar_producto.php?id=<?= $producto["id"] ?>" class="text-sm font-medium text-blue-600 hover:text-blue-800">Editar</a>
                        <a href="eliminar_producto.php?id=<?= $producto["id"] ?>" onclick="return confirm('¿Estás seguro de eliminar este producto?')" class="text-sm font-medium text-red-600 hover:text-red-800">Eliminar</a>
                    </div>       
                </td>
            </tr>
            <?php 
